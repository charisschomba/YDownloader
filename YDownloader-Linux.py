...
file ='/home/{}/Downloads/Urls.txt'.format(user)
ulr_list_dir ='/home/{}/Downloads'.format(user)
...
def mp3(url):
    path="/home/{}/Downloads/Music".format(user)
    os.chdir(path)
    songs=pafy.new(url)
    ...
    file_path = "/home/{}/Downloads/Music/{}".format(user,file)
    new_file = "/home/{}/Downloads/Music/{}".format(user,renamed)
    os.rename(file_path,new_file)
    print('Download Completed ')

def mp4(url):
    path="/home/{}/Downloads/Video".format(user)
    os.chdir(path)
    songs=pafy.new(url)
...
def playlist(url):
    plurl = url
    playlist = pafy.get_playlist(url)
    path="/home/{}/Downloads".format(user) +"/Playlist/{}".format(playlist['title'])
    join_=os.path.join(path)
    file ='/home{}/Downloads/Playlist'.format(user)
